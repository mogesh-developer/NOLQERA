...
def build_nolqera_pipeline() -> NOLQERAPipeline:
    ...
    return create_default_configured_pipeline(
        ...
        config=PipelineConfig(max_sentences=8),
    )
...
def main():
    ...
    optimized_words = word_count(optimized_context)
    ...
    print("OPTIMIZED WORDS :", optimized_words)
    ...
    print()
    print("=" * 72)
    print("4. NOLQERA CONTEXT → QWEN3")
    print("=" * 72)

    optimized_answer, optimized_latency = call_ollama(
